      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => {
            const showSupervisor = Boolean(exp.supervisor && String(exp.supervisor).trim())
                ...
                <div className="p-8">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-6">
                    ...
                    {showSupervisor && (
                      <div className="bg-gradient-to-br from-pink-500/10 to-purple-500/10 p-4 rounded-xl border border-pink-500/20">
                        ...
                        {exp.phone && String(exp.phone).trim() && (
                          <div className="flex items-center mt-2 text-purple-400">
                            <Phone className="w-4 h-4 mr-2" />
                            <a
                              href={`tel:${String(exp.phone).replace(/\s/g, '')}`}
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-100 mb-4">
                      {t('experience.responsibilitiesHeading')}
                    </h4>
